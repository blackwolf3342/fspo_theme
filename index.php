        ...
        <main id="main" class="site-main">
            <section class="paralax-top" >
                ...
                <div id="slider-wrapper">
                    <div class="slide"  >
                        <div class="img-wrapper" style="background-image: url('<? echo get_theme_mod('img-upload') ?>');">

                        </div>
                    </div>
                    <div class="slide" >
                        <div class="img-wrapper" style="background-image: url('<? echo get_theme_mod('img-upload1') ?>');">

                        </div>
                    </div>
                    <div class="slide" >
                        <div class="img-wrapper" style="background-image: url('<? echo get_theme_mod('img-upload2') ?>');">

                        </div>
                    </div>
                    <div class="slide" >
                        <div class="img-wrapper" style="background-image: url('<? echo get_theme_mod('img-upload3') ?>');">
